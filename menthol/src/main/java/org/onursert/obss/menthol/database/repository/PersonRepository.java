package org.onursert.obss.menthol.database.repository;
...
import org.onursert.obss.menthol.database.model.Person;
...
public class PersonRepository {
    ...
    public List<String> getAllPersonNames() {
        List<String> list = ldapTemplate.search(query().where("objectclass").is("person"), new PersonNameAttributesMapper());
        return list;
    }
